...
/// Errors that can occur during PYROS runtime operations.
...
/// Convenience alias for `std::result::Result<T, PyrosError>`.
pub type Result<T> = std::result::Result<T, PyrosError>;
