//! End-to-end test: construct vector_add kernel via PYROS IR, emit PTX,
...
//! PYROS is proven: Rust IR → PTX text → GPU execution.
...
use pyros_runtime::{LaunchConfig, PyrosDevice};

/// Build the vector_add kernel IR and emit it to a PTX string.
///
/// This is the same IR construction as `pyros-core/tests/vector_add_emit.rs`,
