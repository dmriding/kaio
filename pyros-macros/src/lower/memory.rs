...
mod tests {
    ...
    fn address_calc_f32_sizeof_4() {
        ...
        let array_reg = Ident::new("_pyros_r0", Span::call_site());
        let index_reg = Ident::new("_pyros_r1", Span::call_site());
    ...
    fn lower_index_write_f32() {
        ...
        let array_reg = Ident::new("_pyros_r0", Span::call_site());
        let index_reg = Ident::new("_pyros_r1", Span::call_site());
        let value_reg = Ident::new("_pyros_r2", Span::call_site());
    ...
    fn cvta_cached_across_accesses() {
        let mut ctx = LoweringContext::new();
        let array_reg = Ident::new("_pyros_r0", Span::call_site());
        let idx1 = Ident::new("_pyros_r1", Span::call_site());
        let idx2 = Ident::new("_pyros_r2", Span::call_site());
