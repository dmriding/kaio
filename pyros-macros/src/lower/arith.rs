//! Lower arithmetic binary operations to `pyros-core` IR construction code.
...
mod tests {
    ...
    fn lower_add_produces_arith_op() {
        ...
        let lhs = Ident::new("_pyros_r0", proc_macro2::Span::call_site());
        let rhs = Ident::new("_pyros_r1", proc_macro2::Span::call_site());
    ...
    fn lower_neg_produces_neg_op() {
        let mut ctx = LoweringContext::new();
        let src = Ident::new("_pyros_r0", proc_macro2::Span::call_site());
