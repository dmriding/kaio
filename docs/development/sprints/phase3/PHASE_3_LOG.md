...
|---|---|---|---|---|
| [3.1](sprint_3_1.md) | Loops (`for`/`while`) + compound assignment (`+=`) | Done | `pending` | +16 host, +3 GPU = 181+8 |
| [3.2](sprint_3_2.md) | Shared memory + barrier + shuffle instructions (kaio-core) | Planning | — | — |
